      ...
      <div class="row">
        ...
        <div class="offset-md-1 col-md-10" id="reviews-container">
            ...
            <div class="col-md-12" id="review-form-container">
                ...
                <form action="<?= $BASE_URL ?>review_process.php" id="review-form" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="review" id="review" rows="3" placeholder="O que você achou desse filme?"></textarea>
                    </div>
                    <input type="submit" class="btn card-btn" value="Enviar coméntario">
                </form>
            </div>
            <?php endif;?>
            <!-- Comentários -->
            ...
            <?php if(count($moviesReviews) == 0): ?>
                <p class="empty-list">Não há críticas para esse filme ainda ... </p>
            <?php endif; ?>
        </div>
      </div>
    </div>
